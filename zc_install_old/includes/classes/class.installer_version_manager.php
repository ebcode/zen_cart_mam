  ...
  class versionManager extends base{
    ...
    function versionManager() {
      ...
      //$this->latest_version = '1.3.9';
		...
		$this->latest_version = '1.3.9_Multiple_Address_Mod';  //-Multiple Addresses
...
//      $this->version113 = $this->check_version_113();  // there were no db changes for 1.1.3
	  ...
	  $this->version139_Multiple_Addresses_Mod = $this->check_version_139_Multiple_Addresses_Mod();  //Multiple Addresses Mod
...
//        if ($this->version104 == true)  $retVal = '1.0.4';
		...
		if ($this->version139_Multiple_Addresses_Mod == true) $retVal = '1.3.9_Multiple_Addresses_Mod'; //Multiple Addresses
	...
	function check_version_139_Multiple_Addresses_Mod() {  //Multiple Addresses Mod
      global $db_test;
      $got_v1_3_9_Multiple_Addresses_Mod = false;
	  
	  //check for orders_products_multiple_addresses table
	  $sql = "show tables like 'multiple_addresses_customers_baskets_products_orders'";
	  
	  $result = $db_test->Execute($sql);
	  
	  $num_rows = $result->number_of_rows;
	  
	  if($num_rows){
	  		$got_v1_3_9_Multiple_Addresses_Mod = true;
	  }
	  
	  return $got_v1_3_9_Multiple_Addresses_Mod;
