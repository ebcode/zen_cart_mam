...
<!--    <div class="section">
    ...
    <legend><strong><?php echo CHOOSE_UPGRADES; ?></strong></legend>
      ...
      <div class="input">
      <input <?php if ($needs_v1_3_9_Multiple_Addresses_Mod) {echo "checked";} ?> name="version[]" type="checkbox" id="checkbox22" value="1.3.9" tabindex="22" />
      <label for="checkbox21">Upgrade DB from 1.3.9 to 1.3.9_Multiple_Addresses_Mod</label>
    </div>
