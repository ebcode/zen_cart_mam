...
CREATE TABLE address_book (
  ...
  entry_title varchar(128) default 'default',
...
CREATE TABLE orders (
  ...
  multiple_addresses tinyint(1) default '0',
...
# 
# Table structure for table 'multiple_addresses_customers_baskets_products_orders'
#

DROP TABLE IF EXISTS multiple_addresses_customers_baskets_products_orders;
CREATE TABLE multiple_addresses_customers_baskets_products_orders(multiple_addresses_customers_baskets_products_orders_id int(11) PRIMARY KEY AUTO_INCREMENT, customers_basket_id int(11), customers_id int(11), orders_products_id int(11), orders_id int(11), products_id int(11), products_quantity_for_this_address smallint unsigned, address_book_id int(11), shipping_method varchar(128), shipping_module_code varchar(32), cost decimal(15,4) default '0.000', shipping_method_title varchar(128), entry_company varchar(64), entry_firstname varchar(32), entry_lastname varchar(32), entry_street_address varchar(64), entry_suburb varchar(32), entry_postcode varchar(10), entry_city varchar(32), entry_state varchar(32), entry_country_id int(11), entry_zone_id int(11)
) ENGINE=MyISAM;

#create table to store customers_id for toggling a multiple address checkout 

DROP TABLE IF EXISTS multiple_addresses_mod;
CREATE TABLE multiple_addresses_mod(customers_id int(11) NOT NULL default '0'
) ENGINE=MyISAM;

INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Address Book Entry Title', 'ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH', '2', 'Minimum length of address book entry titles ', '2', '4', now());
...
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '3.9h_Multiple_Addresses_Mod', '', '', '', '', 'Fresh Installation', now());
INSERT INTO project_version (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch1, project_version_patch1_source, project_version_patch2, project_version_patch2_source, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '3.9h_Multiple_Addresses_Mod', '', '', '', '', 'Fresh Installation', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (1, 'Zen-Cart Main', '1', '3.9h_Multiple_Addresses_Mod', '', 'Fresh Installation', now());
INSERT INTO project_version_history (project_version_id, project_version_key, project_version_major, project_version_minor, project_version_patch, project_version_comment, project_version_date_applied) VALUES (2, 'Zen-Cart Database', '1', '3.9h_Multiple_Addresses_Mod', '', 'Fresh Installation', now());
