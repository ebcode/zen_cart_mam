...
function install_image_handler() {
  ...
  //--------------------------------------
	// ZOOM_IMAGE_SIZE configuration entry
	//--------------------------------------
  ...
  //--------------------------------------
  // SMALL_IMAGE_HOTZONE configuration entry - Deprecated in Rev 8
  //--------------------------------------
...
//  $db->Execute($sql_query);
	...
	//---------------------------------------
	// ZOOM_MEDIUM_IMAGES configuration entry - Deprecated in Rev 8
	//---------------------------------------
...
//	$db->Execute($sql_query);
  ...
  //-----------------------------------------
  // MEDIUM_IMAGE_HOTZONE configuration entry - Deprecated in Rev 8
  //-----------------------------------------
...
//  $db->Execute($sql_query);
	...
	//---------------------------------
	// ZOOM_GRAVITY configuration entry - Deprecated in Rev 8
	//---------------------------------
//	$sql_query = '';
