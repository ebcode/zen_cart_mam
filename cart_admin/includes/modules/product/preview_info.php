  ...
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $product = $db->Execute("select p.products_id, pd.language_id, pd.products_name,
                                      ...
                                      p.products_model, p.products_image, p.products_image_label, p.products_price, p.products_virtual,
...
?>
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="main">DESCRIPTION: <br> <?php echo $pInfo->products_description;?>
...
//auto replace with defined missing image
           ...
           ?><br><?php echo $pInfo->products_image_label;?>
           </div>
            <?php
			} else { ?>
            	<div style="float:left;margin:2px; text-align:center;">
          ...
          ?>
           ...
           <?php if($products_image_2_name!='') { ?>
           	<div style="float:left;margin:2px; text-align:center;">
	           	<?php
	           		echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_2_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"');        
	           	?><br><?php echo $pInfo->products_image_2_label;?>
           	</div>
		   <?php } ?>
		   <?php if($products_image_3_name!='') { ?>
           	<div style="float:left;margin:2px; text-align:center;">
	           	<?php
	           		echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_3_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"');        
	           	?><br><?php echo $pInfo->products_image_3_label;?>
           	</div>
		   <?php } ?>
		   <?php if($products_image_4_name!='') { ?>
           	<div style="float:left;margin:2px; text-align:center;">
	           	<?php
	           		echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_4_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"');        
	           	?><br><?php echo $pInfo->products_image_4_label;?>
           	</div>
		   <?php } ?>
		   <?php if($products_image_5_name!='') { ?>
           	<div style="float:left;margin:2px; text-align:center;">
	           	<?php
	           		echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_5_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"');        
	           	?><br><?php echo $pInfo->products_image_5_label;?>
           	</div>
		   <?php } ?>
		   <?php if($products_image_6_name!='') { ?>
           	<div style="float:left;margin:2px; text-align:center;">
	           	<?php
	           		echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_6_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"');        
	           	?><br><?php echo $pInfo->products_image_6_label;?>
           	</div>
		   <?php } ?>
...
/* Re-Post all POST'ed variables */
	...
	echo zen_draw_hidden_field('products_image_2', stripslashes($products_image_2_name));
	echo zen_draw_hidden_field('products_image_3', stripslashes($products_image_3_name));
	echo zen_draw_hidden_field('products_image_4', stripslashes($products_image_4_name));
	echo zen_draw_hidden_field('products_image_5', stripslashes($products_image_5_name));
	echo zen_draw_hidden_field('products_image_6', stripslashes($products_image_6_name));	
