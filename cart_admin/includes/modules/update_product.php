 ...
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    $sql_data_array = array('products_quantity' => $products_quantity,
                            ...
                            'products_image_label' => zen_db_prepare_input($_POST['products_image_label']),
                            'products_image_2_label' => zen_db_prepare_input($_POST['products_image_2_label']),
                            'products_image_3_label' => zen_db_prepare_input($_POST['products_image_3_label']),
                            'products_image_4_label' => zen_db_prepare_input($_POST['products_image_4_label']),
                            'products_image_5_label' => zen_db_prepare_input($_POST['products_image_5_label']),
                            'products_image_6_label' => zen_db_prepare_input($_POST['products_image_6_label']),
                            'products_image_7_label' => zen_db_prepare_input($_POST['products_image_7_label']),
                            'products_image_8_label' => zen_db_prepare_input($_POST['products_image_8_label']),
                            'products_image_9_label' => zen_db_prepare_input($_POST['products_image_9_label'])
                            );
	...
	for($zz=2;$zz<7;$zz++){
		$sql_data_array['products_image_'.$zz] = zen_db_prepare_input($_POST['products_image_'.$zz]);
	}
...
if ($_POST['image_delete'] == 1) {
    ...
    if ($new_image == 'true' and IMAGE_MANAGER_HANDLER >= 1) {
		...
		echo "FUTURE IMAGE HANDLER CODE";
