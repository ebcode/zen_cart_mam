...
//die('<br>OK');
    switch($entry['autoType']) {
       ...
       */
      //echo "<br>requiring: ".$baseDir . $entry['loadFile'];
	if(file_exists($baseDir . $entry['loadFile'])){
		//echo "<br>FILE EXISTS";
	} else {
		//echo `pwd`;
		//echo "<br>COULD NOT REQUIRE";
	}
      //echo "<br><br> trying to require : " . $baseDir . $entry['loadFile'];
