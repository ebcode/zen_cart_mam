...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if ($error == true) {
    ...
    //add account to constant contact.. 
    //echo "<br>419: newsletter = $newsletter";
    //--elibird 9/28/2014
    if($newsletter){
        //require('includes/constant_contact.php');

        //add to newsletter_emails database
        $db->Execute("insert into newsletter_emails (fname, lname, email) values ('" . $firstname ."','" . $lastname ."','" .$email_address . "')");
