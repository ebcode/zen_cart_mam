 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  p.products_quantity, p.products_image, p.products_image_label,
...
// if review must be approved or disabled do not show review
  ...
  if ($product_info->fields['products_image'] == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == '1') {
    ...
    /* added by elibird@gmail.com */
    $products_image_label = $product_info->fields['products_image_label'];
    $products_image_2 = $product_info->fields['products_image_2'];
    $products_image_2_label = $product_info->fields['products_image_2_label'];
	$products_image_3 = $product_info->fields['products_image_3'];
    $products_image_3_label = $product_info->fields['products_image_3_label'];
	$products_image_4 = $product_info->fields['products_image_4'];
    $products_image_4_label = $product_info->fields['products_image_4_label'];
	$products_image_5 = $product_info->fields['products_image_5'];
    $products_image_5_label = $product_info->fields['products_image_5_label'];
	$products_image_6 = $product_info->fields['products_image_6'];
    $products_image_6_label = $product_info->fields['products_image_6_label'];
	$products_image_7 = $product_info->fields['products_image_7'];
    $products_image_7_label = $product_info->fields['products_image_7_label'];
	$products_image_8 = $product_info->fields['products_image_8'];
    $products_image_8_label = $product_info->fields['products_image_8_label'];
	$products_image_9 = $product_info->fields['products_image_9'];
    $products_image_9_label = $product_info->fields['products_image_9_label'];
  }
