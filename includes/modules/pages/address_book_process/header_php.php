...
//  $entry_title = zen_db_prepare_input(zen_sanitize_string($_POST['entry_title']));  //Multiple Addresses Mod
  ...
  $entry_title = $firstname . ' ' . $lastname;
  
  //$phone = zen_db_prepare_input(zen_sanitize_string($_POST['phone'])); //Multiple Addresses Mod
  ...
  //echo "<br>ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH = " .ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH;
/*
  if (strlen($entry_title) < ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH) {  //Multiple Addresses Mod
    $error = true;
    $messageStack->add('addressbook', ENTRY_TITLE_ERROR_MIN);
  }
  
  //echo "<br>ADDRESS_BOOK_ENTRY_TITLE_MAX_LENGTH = " .ADDRESS_BOOK_ENTRY_TITLE_MAX_LENGTH;
  
  if (strlen($entry_title) > ADDRESS_BOOK_ENTRY_TITLE_MAX_LENGTH) {  //Multiple Addresses Mod
    $error = true;
    $messageStack->add('addressbook', ENTRY_TITLE_ERROR_MAX);
  }
  */

/*
  if (strlen($phone) < 9) {  //Multiple Addresses Mod
    $error = true;
    $messageStack->add('addressbook', 'Phone must contain at least 9 digits.');
  }
  */
  ...
  if ($error == false) {
    $sql_data_array= array(array('fieldName'=>'entry_title', 'value'=>$entry_title, 'type'=>'string'),
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
  $entry_query = "SELECT entry_title, entry_gender, entry_company, entry_firstname, entry_lastname,
                  ...
                  AND    address_book_id = :addressBookID";  //Multiple Addresses Mod, added entry_title
