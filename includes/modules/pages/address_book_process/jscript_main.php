...
function check_input_max(field_name, field_size, message) {
  if (form.elements[field_name] && (form.elements[field_name].type != "hidden")) {
    if (field_size == 0) return;
    var field_value = form.elements[field_name].value;
...
<?php 
/*
if ((int)ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH > 0) {  //Multiple Addresses Mod ?>
  check_input("entry_title", 2, "<?php echo ENTRY_TITLE_ERROR_MIN; ?>");
<?php } 
*/
?>
...
<?php
/*
 if ((int)ADDRESS_BOOK_ENTRY_TITLE_MAX_LENGTH > 0) {  //Multiple Addresses Mod ?>
  check_input_max("entry_title", 20, "<?php echo ENTRY_TITLE_ERROR_MAX; ?>");
<?php 
...
check_input("phone", 9, "Phone must contain at least 9 digits.");
