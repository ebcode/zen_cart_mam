...
$gift_price = number_format($insurable_value, 2, '.', '');

if($gift_price <= 199.95){
$length = '20';
$height = '16';
$width = '16';
$this->pounds = '17';
...
//echo "<br>gift price = $gift_price";

$size = '<Size>LARGE</Size>';


$girth = $width + $width + $height + $height;
...
//echo "sent request to usps: <br>";
//echo htmlspecialchars(urldecode($request));
