...
// class constructor
    function flat() {
      ...
      if (zen_get_shipping_enabled($this->code)) {
        ...
        //also disable when the order is less than $49.95
        //var_dump($order);
        //echo "subtotal = " . $order->info['subtotal'];

                    
//echo "PRICE = " . $order->info['subtotal'];
