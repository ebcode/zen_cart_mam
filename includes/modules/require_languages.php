...
while(list ($key, $value) = each($directory_array)) {
  //echo "<br>I AM LOADING: " . $language_page_directory . $template_dir_select . $value . '<br />';
  require_once($language_page_directory . $template_dir_select . $value);
}

//Multiple Addresses Mod
//echo "<br>current page base = $current_page_base<br><br>";
//$current_page_base = 'checkout';  //Multiple Addressses Mod
  $is_checkout = (substr($current_page_base,0,8)=='checkout')?1:0;  
  
  if($is_checkout){
  	//echo "<br> include checkout files:<br>";
	//echo $language_page_directory . $template_dir_select . 'checkout_steps.php';
  	require_once($language_page_directory . $template_dir_select . 'checkout_steps.php');
  }
