...
class moneybookersPoli extends moneybookers_payment {

	var $_prefix = 'MODULE_PAYMENT_MONEYBOOKERS_POLI_';
	var $_imgLink = 'http://www.moneybookers.com/creatives/logos/poweredby_logos/nomb/120x60px/poli.gif';
	var $_paymentMethod = "PLI";
	var $_returnUrl;
	var $_zoneId = 10012;
  
	function moneybookersPoli() {
		global $messageStack;

		$this->code = __CLASS__;
		$this->codeVersion = '0.0.1.a';
		$this->description = 'POLi';
		$this->title = "POLi (powered by moneybookers) - Australia";
