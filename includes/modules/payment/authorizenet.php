...
//$this->form_action_url = 'https://developer.authorize.net/tools/paramdump/index.php';

    //--elibird 12/16/2013

    //$this->form_action_url = 'https://dev.anythinginabasket.com/dev/gift_baskets/hey.php';
  ...
  function process_button() {
    ...
    $submit_data_core = array(
      ...
      'x_amount' => (isset($_SESSION['multiple_addresses']))?number_format($_SESSION['multiple_addresses_grand_total'], 2):number_format($order->info['total'], 2),
...
if(isset($_SESSION['multiple_addresses'])){
    ...
    $submit_data_security = $this->InsertFP(MODULE_PAYMENT_AUTHORIZENET_LOGIN, MODULE_PAYMENT_AUTHORIZENET_TXNKEY, number_format($_SESSION['multiple_addresses_grand_total'], 2), $sequence);
...
//    if (isset($this->reportable_submit_data['x_card_code'])) $this->reportable_submit_data['x_card_code'] = '*******';
  ...
  function before_process() {
    ...
    //--elibird . forcing pass on authorizenet payments
    ...
    //--elibird.  will want to fix this as soon as I can find out
// why authorize.net is failing to return to the confirmation page properly.
