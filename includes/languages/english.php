...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">Anything In A Basket</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
...
define('ENTRY_TITLE_TEXT', '*');
define('ENTRY_TITLE_ERROR_MIN', 'The entry title must contain a minimum of ' . ADDRESS_BOOK_ENTRY_TITLE_MIN_LENGTH . ' characters.');
define('ENTRY_TITLE_ERROR_MAX', 'The entry title must contain a maximum of ' . ADDRESS_BOOK_ENTRY_TITLE_MAX_LENGTH . ' characters.');

define('SELECT','- select -');
define('SHIP_TO', 'Ship To');
define('ERROR_MULTIPLE_SHIPMENTS_SELECT','Please select a shipping method with a dollar amount for each address.');

define('TABLE_HEADING_ADDRESS', 'Address');
define('TABLE_HEADING_HOW_MANY_ADDRESSES', 'Ship to how many addresses?');
define('TABLE_HEADING_SELECT_SHIPPING_METHOD', 'Select Shipping Method');
define('TABLE_HEADING_MAX', 'Max.');
define('TABLE_HEADING_HOW_MANY', 'How Many?');
define('TABLE_HEADING_WHICH_ADDRESS', 'Which Address?');
define('MY_ACCOUNT_MULTIPLE_ADDRESSES', 'Multiple Addresses:');
define('GRAND_TOTAL', 'Grand Total:');
define('TABLE_HEADING_SHIPPING_METHOD','Select Shipping Option');
define('DELIVERY_INFORMATION','Delivery Information');
