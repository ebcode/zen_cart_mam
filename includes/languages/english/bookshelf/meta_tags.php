...
define('TITLE', 'Custom Handmade Gift Baskets from Long Island, NY');
...
define('CUSTOM_KEYWORDS', 'Shop By Occasion, Holiday Baskets, Browse Baskets, Gift Ideas For Kids, Custom Handmade Gift Baskets, Gourmet Shiva Gift Baskets');



// Home Page Only:

  define('HOME_PAGE_META_DESCRIPTION', 'Anything in a Basket ~ Elegant, Affordable, Handmade Custom Gift Baskets Since 1988. Build Your Own Basket! Order Online today!');

  define('HOME_PAGE_META_KEYWORDS', 'Shop By Occasion, Holiday Baskets, Browse Baskets, Gift Ideas For Kids, Custom Gourmet Gift Baskets, Gourmet Shiva Gift Baskets');



  // NOTE: If HOME_PAGE_TITLE is left blank (default) then TITLE and SITE_TAGLINE will be used instead.

  define('HOME_PAGE_TITLE', 'Custom Handmade Gift Baskets from Long Island, NY'); // usually best left blank
