...
define('TITLE', 'The Bookshelf');



// Site Tagline

define('SITE_TAGLINE', 'Free Zencart Template');



// Custom Keywords

define('CUSTOM_KEYWORDS', 'free, template, design, skin, ecommerce, open source, shop, online shopping');
