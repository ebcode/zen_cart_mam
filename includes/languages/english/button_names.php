...
define('BUTTON_IMAGE_ADD_ADDRESS', 'add_address.png');
...
define('BUTTON_IMAGE_CHANGE_ADDRESS', 'edit_address.png');

define('BUTTON_IMAGE_CHANGE_BILLING_ADDRESS', 'edit_billing_address.png');

//define('BUTTON_IMAGE_CHECKOUT', 'button_checkout.gif');
define('BUTTON_IMAGE_CHECKOUT', 'enter_delivery_addresses.png');
...
define('BUTTON_IMAGE_IN_CART', 'button_in_cart2.png');
...
define('BUTTON_IMAGE_CONTINUE_CHECKOUT', 'continue_to_checkout.png');
...
define('BUTTON_IMAGE_CONTINUE_NEW', 'continue.png');
...
define('BUTTON_ADD_ADDRESS_ALT', 'Edit Address');
...
define('BUTTON_CONFIRM_SHIPPING_ADDRESS', 'button_confirm_shipping_address.png'); 
define('BUTTON_CONFIRM_SHIPPING_ADDRESS_ALT', 'confirm shipping address');

define('BUTTON_ADD_SHIPPING_ADDRESS', 'edit_delivery_addresses.png'); 
define('BUTTON_ADD_SHIPPING_ADDRESS_ALT', 'add shipping address');

define('BUTTON_IMAGE_SINGLE_ADDRESS', 'ship_to_single_address.png'); 
define('BUTTON_IMAGE_SINGLE_ADDRESS_ALT', 'use single address');

define('BUTTON_IMAGE_PREVIOUS_CHECKOUT', 'button_previous_checkout.gif');
define('BUTTON_DELIVERY_OPTIONS', 'delivery_options.png');

define('BUTTON_ENTER_DELIVERY_INFORMATION', 'enter_delivery_information.png');

define('BUTTON_EDIT_DELIVERY_ADDRESS', 'edit_delivery_address.png');

define('BUTTON_PAYMENT_OPTIONS', 'payment_options.png');

define('BUTTON_PREVIOUS_CHECKOUT_ALT', 'Save this information and return to the previous page.');

define('BUTTON_IMAGE_MULTIPLE_ADDRESSES', 'choose_multiple_addresses.png');
define('BUTTON_MULTIPLE_ADDRESSES_ALT', 'ship to multiple addresses');

define('BUTTON_ADD_ADDRESS', 'edit_address.png');

define('BUTTON_EDIT_DELIVERY_ADDRESS', 'edit_delivery_address.png');

define('BUTTON_GIFT_MESSAGES', 'gift_messages_review.png');

define('BUTTON_PAYMENT_INFORMATION', 'payment_information.png');
