...
define('TEXT_INFORMATION', 'You may use the form below to update the quantities of items in your cart.  Use the buttons at the bottom of the page to either continue shopping or begin the checkout process.');
