...
define('HEADING_TITLE', 'Gift Messages &amp; Review');
...
define('HEADING_PRODUCTS', 'Enter Gift Message(s)');
...
define('TITLE_PREVIOUS_CHECKOUT_PROCEDURE', '<strong>Return to Step 2</strong>');
define('TEXT_PREVIOUS_CHECKOUT_PROCEDURE', '- to confirm your payment information.');
