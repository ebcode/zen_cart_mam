...
// whats_new box text in sideboxes/whats_new.php
  ...
  define('CATEGORIES_BOX_HEADING_WHATS_NEW', 'Gift Baskets for all occasions');
...
//New billing address text
  define('SET_AS_PRIMARY' , 'Set as Customer Address');
...
// javascript messages
  ...
  define('ENTRY_SELECT_ADDRESS', 'Please enter a delivery address or choose from your address book entries.');
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> products)');
...
// textarea attribute input fields
  define('TEXT_MAXIMUM_CHARACTERS_ALLOWED',' max');
...
// sort order titles for dropdowns
  ...
  define('TEXT_INFO_SORT_BY_PRODUCTS_MODEL', 'Product #');
