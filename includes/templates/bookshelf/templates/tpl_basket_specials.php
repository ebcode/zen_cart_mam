...
<link rel="stylesheet" type="text/css" href="./includes/templates/bookshelf/css/stylesheet_zen_lightbox.css" />
    <div style="width:1000px; background-color:white; background-image:url('./images/gradient.png');margin:auto;">
        ...
        <div align="center" >
        <a href="#"><img style="border:0; float:left; margin-left:15px;" alt="A Tisket A Tasket Anything In A Basket" src="includes/templates/bookshelf/images/new_tisket3.png" ></a></div><div class="instructions">
        <?php 

//die($_SERVER['DOCUMENT_ROOT'].'/gift_baskets/includes/languages/english/html_includes/bookshelf/define_page_6.php');

require($_SERVER['DOCUMENT_ROOT'].'/includes/languages/english/html_includes/define_basket_specials.php');
?>
        <br style="clear:both;"> 
        </div>
