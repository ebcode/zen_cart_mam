...
<?php
  ...
  if(isset($_SESSION['byob_id']) && in_array($product['id'],$byob_product_ids)){
	?>
	<div align="left">
...
while (!$byob_items->EOF) {
	...
	$subindex++;
	*/
	echo "".$byob_items->fields['nm']." .......... x ". $byob_items->fields['quantity']."<br>";
	$byob_items->MoveNext();
} ?>
</div>
<?php  
...
<div class="buttonRow back">
    <a href="index.php"><img src="includes/templates/template_default/buttons/english/<?php echo BUTTON_IMAGE_CONTINUE_SHOPPING;?>"></a>
    <?php //echo zen_back_link() . zen_image_button(BUTTON_IMAGE_CONTINUE_SHOPPING, BUTTON_CONTINUE_SHOPPING_ALT) . '</a>'; ?></div>
<?php
...
window.onload = function(){
   /*
    $('.cartQuantity input').change(function(){
       document.forms['cart_quantity'].submit(); 
    });
    */
   
   var nodes = document.getElementsByName('cart_quantity[]');
   
   for(x in nodes){
    nodes[x].onchange = function(){
        document.forms['cart_quantity'].submit();
   }   
   }
