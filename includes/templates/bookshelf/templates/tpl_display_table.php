...
require($_SERVER['DOCUMENT_ROOT'].'/includes/languages/english/html_includes/bookshelf/define_page_6.php');
?>  </div>
        <br style="clear:both;"> 
        </div>
...
<div id="abox" style="border:1px solid black; height:300px; width:300px; display:none;"></div>
