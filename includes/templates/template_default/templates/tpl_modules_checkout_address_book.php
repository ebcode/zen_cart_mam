...
?>
        <div class="back"><?php //echo zen_draw_radio_field('address', $addresses->fields['address_book_id'], ($addresses->fields['address_book_id'] == $_SESSION['sendto']), 'id="name-' . $addresses->fields['address_book_id'] . '"');

/*  converting radio boxes to checkboxes to allow multiple addresses
zen_draw_checkbox_field($name, $value = '', $checked = false, $parameters = '') 
*/

echo zen_draw_checkbox_field('address[]', $addresses->fields['address_book_id'], $checked = false, 'id="name-' . $addresses->fields['address_book_id'] . '"')

//echo zen_draw_radio_field('address', $addresses->fields['address_book_id'], false, 'id="name-' . $addresses->fields['address_book_id'] . '"');
