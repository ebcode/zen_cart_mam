...
if($_GET['products_id'] != 66){
    ...
    <div id="cartAdd" style="font-weight:bold;">
    <?php
      echo $display_qty;
      echo $display_button;
            ?><br/>
            <span style="font-weight:bold;color:red">Gift Messages are added <br/>on Step 3 of checkout.
             </span>
          </div>
