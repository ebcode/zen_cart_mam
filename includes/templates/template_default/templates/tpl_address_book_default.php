...
*/
//var_dump($addresses);
//dumpvar($addressArray);
//echo "hm=$hm<br>";

?>
<h3 class="addressBookDefaultName"><?php echo zen_output_string_protected($addresses['address']['entry_title']); ?><?php if ($addresses['address_book_id'] == $_SESSION['customer_default_address_id']) echo '&nbsp;' . PRIMARY_ADDRESS ; ?></h3>
...
//Multiple Addresses Mod
if($back_btn_checkout){
    echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_MULTIPLE_ADDRESSES, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_CONTINUE_CHECKOUT, BUTTON_CONTINUE_ALT) . '</a>'; 
} else {
...
?>
<div class="buttonRow back">  <?php echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_ADD_ADDRESS, BUTTON_ADD_ADDRESS_ALT) . '</a>'; ?></div></div>
<br class="clearBoth" />
</div>
