...
<br class="clearBoth" />
<?php //Multiple Addresses Mod 

/*
<label class="inputLabel" for="entry_title"><?php echo ENTRY_TITLE; ?></label>
<?php echo zen_draw_input_field('entry_title', $entry->fields['entry_title'], zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_title', '32') . ' id="entry_title"') . (zen_not_null(ENTRY_TITLE_TEXT) ? '<span class="alert">' . ENTRY_TITLE_TEXT . '</span>': ''); 
*/
?>
...
<?php echo zen_draw_input_field('phone', $entry->fields['entry_phone'], zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_phone', '30') . ' id="phone"') . (zen_not_null(ENTRY_PHONE_TEXT) ? '<span class="alert">' . ENTRY_PHONE_TEXT . '</span>': ''); ?>
<br class="clearBoth" />
-->
<?php
...
?>
<label class="inputLabel" for="suburb"><?php echo ENTRY_SUBURB; ?><br>
...
<br>Please enter floor and suite numbers above, if applicable
<br class="clearBoth" />
<?php
  }
?>
