...
//extra table for multiple addresses, it could use a better name
define('TABLE_MULTIPLE_ADDRESSES_CUSTOMERS_BASKETS_PRODUCTS_ORDERS', DB_PREFIX . 'multiple_addresses_customers_baskets_products_orders');

//extra table to toggle multiple address mode
define('TABLE_MULTIPLE_ADDRESSES_MOD', DB_PREFIX . 'multiple_addresses_mod');
