...
// Define the webserver and path parameters
  ...
  define('HTTP_CATALOG_SERVER', 'http://www.anythinginabasket.com');
...
// * DIR_WS_* = Webserver directories (virtual/URL)
  ...
  define('DIR_WS_ADMIN', '/gift_baskets/cart_admin/');
  define('DIR_WS_CATALOG', '/gift_baskets/');
  define('DIR_WS_HTTPS_ADMIN', '/gift_baskets/cart_admin/');
