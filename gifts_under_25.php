...
//detect $_SESSION['byob'] and offer to empty basket or redirect to checkout
    ...
    $q = "select p.products_image, p.products_price, p.sold, p.products_quantity, pd.* from products p left join products_description pd on p.products_id = pd.products_id where p.master_categories_id = '55' and products_status = 1 order by products_sort_order";
